...
export const Layout: React.FC = () => {
  ...
  const userLinks = [
    ...
    { to: "/inventory", label: "View Inventory", icon: <Monitor className="w-4 h-4" /> },
  ...
  const adminLinks = [
    ...
    { to: "/admin/purchases", label: "Purchase Requests", icon: <Package className="w-4 h-4" /> },
    { to: "/admin/inventory", label: "Inventory Mgmt", icon: <Monitor className="w-4 h-4" /> },
    { to: "/admin/active", label: "Active Rentals", icon: <Calendar className="w-4 h-4" /> },
  ];
